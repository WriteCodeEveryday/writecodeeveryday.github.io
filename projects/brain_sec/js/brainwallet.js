(function($){
    ...
    function setErrorState(field, err, msg) {
        //console.log("setErrorState: " + field);
    ...
    $(document).ready( function() {
        //console.log(generateBrainWalletFromHash("abc123"));
